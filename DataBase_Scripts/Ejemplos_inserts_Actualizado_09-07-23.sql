...
SET DATEFORMAT ymd; -- Establece el formato de fecha como año-mes-día

-- Inserts para la tabla Usuarios
INSERT INTO Usuarios (IDTipoUsuario, Contrasenia, Email, Estado, EsAdmin, ResetToken, ResetTokenExpiracion) VALUES
(3, 'contraseña1', 'usuario1@example.com', 1, 0, NULL, NULL),
(3, 'contraseña2', 'usuario2@example.com', 1, 0, NULL, NULL),
(2, 'contraseña3', 'admin@example.com', 1, 1, NULL, NULL);
...
(3, 'Visitamos un refugio y conocimos a muchos animales que necesitan adopción.', '','2023-06-14 16:00:00',1);
